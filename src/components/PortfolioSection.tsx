...
const projects: Project[] = [
  {
    ...
    description: "Moderna web platforma sa integrisanom prodavnicom — brz, responzivan sajt prilagođen konverziji i korisničkom iskustvu.",
    tags: ["Web sajt", "Web dizajn", "E-Commerce"],
    image: portfolioUnearthed,
    url: "unearthed-samples.com",
  },
  {
    title: "CrowdPlay",
    description: "Kompletna web aplikacija sa naprednim funkcionalnostima i integracijama — skalabilno rešenje izrađeno po meri klijenta.",
    tags: ["Web aplikacija", "SaaS", "Custom razvoj"],
    image: portfolioCrowdplay,
    url: "crowdplay.eu",
  },
  {
    title: "Sarastra Marketing",
    description: "Profesionalan poslovni sajt sa modernim dizajnom, optimizovan za SEO i predstavljanje brenda na najbolji način.",
    tags: ["Web sajt", "Web dizajn", "Brending"],
    image: portfolioSara,
    url: "sarastra-marketing.com",
  },
  {
    title: "Treba.mi",
    description: "Web platforma sa naprednim funkcionalnostima — povezuje korisnike kroz intuitivan interfejs i pouzdan sistem.",
    tags: ["Web aplikacija", "Platforma", "Custom razvoj"],
    image: portfolioTrebami,
    url: "treba.mi",
  },
  {
    title: "Neural.live",
    description: "Interaktivna web aplikacija sa naprednom tehnologijom — moderan dizajn i besprekorno korisničko iskustvo.",
    tags: ["Web aplikacija", "Interaktivno", "Custom razvoj"],
    image: portfolioNeural,
    url: "neural.live",
  },
  {
    title: "The Fake Escape",
    description: "Mobilna aplikacija sa modernim UI/UX dizajnom — jednostavna, brza i intuitivna za svakodnevnu upotrebu.",
    tags: ["Mobilna aplikacija", "UI/UX dizajn", "iOS"],
    image: portfolioFakeescape,
    url: "thefakeescape.app",
  },
  {
    title: "Tippr",
    description: "Dinamična web aplikacija sa real-time funkcionalnostima — angažuje zajednicu i pruža interaktivno iskustvo.",
